...
something.length; // (way-01) apply type assertion | (gives string related auto-suggestion)
something.length; // (way-02) apply type assertion
/* Variable Example-02 */
let something2; // type any
something2 = 666;
something2.toFixed(); // (way-01) apply type assertion | (gives number related auto-suggestion)
something2.toFixed(); // (way-02) apply type assertion
/* Function Example */
...
const resultToBeNumber = kgToGram(1000); // (way-01) apply type assertion
const resultToBeNumber2 = kgToGram(1000); // (way-02) apply type assertion
console.log(resultToBeNumber, resultToBeNumber2); // 1000000 1000000
const resultToBeString = kgToGram("1000"); // (way-01) apply type assertion
const resultToBeString2 = kgToGram("1000"); // (way-02) apply type assertion
...
try {
    ...
    console.log(err.message); // (way-01) type assertion
    console.log(err.message); // (way-02) type assertion
}
