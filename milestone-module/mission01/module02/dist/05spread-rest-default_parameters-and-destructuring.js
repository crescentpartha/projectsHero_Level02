...
const greatFriends = (friend1, friend2, friend3) => console.log(`Hi ${friend1} \nHi ${friend2} \nHi ${friend3}`);
...
/* ---------------------------------------------------------- */
// Using Rest Operator
const greatFriends2 = (...friends) => console.log(friends); // [ 'Nayeem', 'Mohon', 'Apu', 'Dipu', 'Topu', 'Tomal' ]
greatFriends2("Nayeem", "Mohon", "Apu", "Dipu", "Topu", "Tomal");
const greatFriends3 = (...friends) => console.log(friends.forEach(friend => console.log(`Hi ${friend}`)));
